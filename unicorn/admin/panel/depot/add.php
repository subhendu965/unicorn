...
if(isset($_POST['submit'])){
	do{
		...
		$query="INSERT INTO depot SET depot='".mysqli_real_escape_string($db,$_POST['depot'])."',";
		...
		if(mysqli_query($db,$query)){
			echo "<h1 style='background:green; font-size:20px; padding:10px; color:white;'>Depot Added<br></h1>";
		}else{
			echo "<h1 style='background:red; font-size:20px; padding:10px; color:white;'>Unable to add depot. Try again.</h1>".mysqli_error($db);
		}

		$query="INSERT INTO stop SET stop='".mysqli_real_escape_string($db,$_POST['depot'])."',";
		$query.="address='".mysqli_real_escape_string($db,$_POST['address'])."',";
		$query.="type='".mysqli_real_escape_string($db,$_POST['type'])."',";
		$query.="remark='".mysqli_real_escape_string($db,$_POST['remark'])."',";
		$query.="passenger_capacity='".mysqli_real_escape_string($db,$_POST['passenger_capacity'])."',";
		...
		if(mysqli_query($db,$query)){
			...
			echo "<h1 style='background:red; font-size:20px; padding:10px; color:white;'>Unable to add stop. Try again.</h1>".mysqli_error($db);
		}
}
...
<br>
<label><div>
Depot: <input type="text" name="depot" hb_code='input' />
</div></label>
