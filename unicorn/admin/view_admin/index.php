...
<div id="main">
	...
	<div id="me">
		...
		<div>
			<a href="/admin/login/logout.php"><div>Log Out</div></a>
		</div>
	</div>
</div>
<?php
}else{
	die("<div style='width:60%; margin:20px auto;text-align:center;'><a href='/admin/login'>login Please first.</a></div>");
}
