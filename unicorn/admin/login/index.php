...
if(isset($_POST['submit'])){
	$query="SELECT email,password,name FROM admins WHERE email='".mysqli_real_escape_string($db,$_POST['email'])."' AND password='".mysqli_real_escape_string($db,$_POST['password'])."' LIMIT 1";
